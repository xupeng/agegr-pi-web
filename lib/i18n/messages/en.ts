...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.chatFontSizeDescription": "Scale the chat message font size relative to the current default. Other parts of the interface are not affected.",
    "settings.fontSizeDefault": "Default",
    "settings.fontSizeDecrease": "Decrease chat font size",
    "settings.fontSizeIncrease": "Increase chat font size",
    "settings.fontSizeReset": "Reset chat font size to default",
    ...
    "settings.extensionUi": "Extension UI",
    "settings.extensionUiDescription": "Hide extension widgets or statuses that are not useful in Pi Web.",
    "settings.hiddenWidgetKeys": "Hidden widget keys",
    "settings.hiddenStatusKeys": "Hidden status keys",
    "settings.extensionUiEmpty": "No hidden keys",
    "settings.extensionUiHint": "Enter one exact key or prefix ending in * per line. Keys identify UI entries, not verified extension packages. Saving reloads the current session.",
    "settings.extensionUiSave": "Save extension UI rules",
    "settings.extensionUiSaving": "Saving...",
    ...
    "trellisSubagent.title": "Trellis executions",
    "trellisSubagent.count": "{count} records",
    "trellisSubagent.truncated": "Some records omitted",
    "trellisSubagent.coverage.complete": "History: full viewed branch",
    "trellisSubagent.coverage.incomplete": "History: partial, older results may be missing",
    "trellisSubagent.snapshotNotice": "Execution snapshot — not a full conversation",
    "trellisSubagent.notRunning": "Status is the last reported value, not live process state",
    "trellisSubagent.lastReported": "Last reported: {status}",
    "trellisSubagent.updated": "Updated {time}",
    "trellisSubagent.step": "Step {step}",
    ...
    "trellisSubagent.omittedTools": "{count} older tools omitted",
    "trellisSubagent.unavailable": "Unavailable",
    "trellisSubagent.upstreamNotice": "Prompt, tail, and tool excerpts may already be truncated by the producer",
    ...
    "trellisSubagent.status.pending": "Pending",
    "trellisSubagent.status.running": "Running",
    "trellisSubagent.status.succeeded": "Succeeded",
    "trellisSubagent.status.failed": "Failed",
    "trellisSubagent.status.cancelled": "Cancelled",
    "trellisSubagent.status.unknown": "Unknown",
    ...
    "chat.writtenFilesCount": "Files: {count}",
    "chat.writtenFileActions": "File actions",
    "chat.fileType.document": "Document",
    "chat.fileType.code": "Code",
    "chat.fileType.image": "Image",
    "chat.fileType.data": "Data",
    "chat.fileType.config": "Config",
    "chat.fileType.other": "File",
    "chat.openFilePreview": "Open preview",
    "chat.openFileDiff": "Open diff",
    "chat.copyFilePath": "Copy path",
    "chat.copyFilePathDone": "Path copied",
    "chat.loadEarlier": "Scroll up to load earlier messages",
    "chat.extensionRequest": "extension request",
    "chat.askUserTitle": "Questions from the agent",
    "chat.askUserAnswered": "{count} of {total} answered",
    "chat.askUserOther": "Other",
    "chat.askUserOtherPlaceholder": "Type your own answer…",
    "chat.askUserMultipleOtherPlaceholder": "Add details (kept alongside the selected options)…",
    "chat.askUserSupplementTitle": "Additional info (optional)",
    "chat.askUserSupplementPlaceholder": "Anything else the agent should know…",
    ...
    "chat.askUserAppFailed": "The question view could not be loaded.",
    "chat.askUserAppFailedHint": "The question is still open. Retry, reload the page, or answer from another device.",
    "chat.askUserAppFailedRetry": "Retry",
    "chat.askUserAppFailedMultiple": "Several options can be selected.",
    ...
    "chat.uploadingImage": "Uploading",
    "chat.processingImage": "Processing",
