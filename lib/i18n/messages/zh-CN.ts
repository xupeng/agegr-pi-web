...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.chatFontSize": "对话区字号",
    "settings.chatFontSizeDescription": "以当前字号为基准，放大或缩小对话消息区的字号，不影响界面其他部分。",
    "settings.fontSizeDefault": "默认",
    "settings.fontSizeDecrease": "减小对话区字号",
    "settings.fontSizeIncrease": "增大对话区字号",
    "settings.fontSizeReset": "恢复对话区默认字号",
    ...
    "settings.extensionUi": "扩展界面",
    "settings.extensionUiDescription": "隐藏在 Pi Web 中没有用途的扩展 Widget 或状态。",
    "settings.hiddenWidgetKeys": "隐藏的 Widget key",
    "settings.hiddenStatusKeys": "隐藏的状态 key",
    "settings.extensionUiEmpty": "不隐藏任何 key",
    "settings.extensionUiHint": "每行输入一个精确 key，或以 * 结尾的前缀。key 标识界面条目，不代表已验证的扩展包；保存后会重新加载当前会话。",
    "settings.extensionUiSave": "保存扩展界面规则",
    "settings.extensionUiSaving": "正在保存...",
    ...
    "trellisSubagent.title": "Trellis 执行记录",
    "trellisSubagent.count": "{count} 条记录",
    "trellisSubagent.truncated": "部分记录已省略",
    "trellisSubagent.coverage.complete": "历史覆盖：完整当前分支",
    "trellisSubagent.coverage.incomplete": "历史覆盖：不完整，较早结果可能缺失",
    "trellisSubagent.snapshotNotice": "执行快照 — 并非完整会话",
    "trellisSubagent.notRunning": "状态为最后一次上报值，不代表进程存活",
    "trellisSubagent.lastReported": "最后上报：{status}",
    "trellisSubagent.updated": "更新于 {time}",
    "trellisSubagent.step": "步骤 {step}",
    "trellisSubagent.stale": "没有持久化记录作为依据",
    "trellisSubagent.omittedBudget": "为满足显示预算而省略了文本",
    "trellisSubagent.omittedTools": "省略了 {count} 个较早的工具调用",
    "trellisSubagent.unavailable": "不可用",
    "trellisSubagent.upstreamNotice": "提示词、尾部与工具摘要可能已被产出方截断",
    "trellisSubagent.displayTruncated": "Pi Web 为满足显示限制进一步截断",
    "trellisSubagent.incomplete": "部分快照字段不可用",
    "trellisSubagent.provenance": "来源",
    "trellisSubagent.evidence.partial": "实时局部快照",
    "trellisSubagent.evidence.toolEnd": "工具完成快照",
    "trellisSubagent.evidence.message": "最终消息快照",
    "trellisSubagent.evidence.history": "已持久化的会话历史",
    "trellisSubagent.mode.single": "单个",
    "trellisSubagent.mode.parallel": "并行",
    "trellisSubagent.mode.chain": "链式",
    "trellisSubagent.mode.unknown": "未知模式",
    "trellisSubagent.status.pending": "等待中",
    "trellisSubagent.status.running": "运行中",
    "trellisSubagent.status.succeeded": "已成功",
    "trellisSubagent.status.failed": "失败",
    "trellisSubagent.status.cancelled": "已取消",
    "trellisSubagent.status.unknown": "未知",
    "trellisSubagent.prompt": "提示词",
    "trellisSubagent.finalResult": "最终结果",
    "trellisSubagent.textTail": "文本尾部",
    "trellisSubagent.thinkingTail": "思考尾部",
    "trellisSubagent.stderrTail": "stderr 尾部",
    "trellisSubagent.tools": "近期工具",
    "trellisSubagent.usage": "用量",
    "trellisSubagent.error": "错误",
    ...
    "chat.stalledTurnAborted": "已自动中止本轮：{tool} 已连续 {minutes} 分钟无输出（已运行 {elapsed}）。",
    "chat.stalledTurnAbortedNoTool": "已自动中止本轮：已连续 {minutes} 分钟无输出（已运行 {elapsed}）。",
    ...
    "chat.writtenFilesCount": "{count} 个文件",
    "chat.writtenFileActions": "文件操作",
    "chat.fileType.document": "文档",
    "chat.fileType.code": "代码",
    "chat.fileType.image": "图片",
    "chat.fileType.data": "数据",
    "chat.fileType.config": "配置",
    "chat.fileType.other": "文件",
    "chat.openFilePreview": "打开预览",
    "chat.openFileDiff": "以 Diff 打开",
    "chat.copyFilePath": "复制路径",
    "chat.copyFilePathDone": "路径已复制",
    "chat.loadEarlier": "向上滚动以加载更早的消息",
    "chat.extensionRequest": "扩展请求",
    "chat.askUserTitle": "来自 agent 的问题",
    "chat.askUserAnswered": "已答 {count}/{total}",
    "chat.askUserOther": "其他",
    "chat.askUserOtherPlaceholder": "输入你自己的答案…",
    "chat.askUserMultipleOtherPlaceholder": "补充说明（可与所选选项同时提交）…",
    "chat.askUserSupplementTitle": "补充信息（可选）",
    "chat.askUserSupplementPlaceholder": "补充问题之外的信息…",
    "chat.askUserSubmitted": "已提交，正在发送你的答案…",
    "chat.askUserCancelling": "取消中…",
    "chat.askUserHint": "答案会作为后续消息发给 agent；留空的问题会被标记为未回答。",
    "chat.askUserActionFailed": "提问操作失败，可以重试。",
    "chat.askUserAppFailed": "问题视图加载失败。",
    "chat.askUserAppFailedHint": "问题仍然开放。可以重试、刷新页面，或从其他设备回答。",
    "chat.askUserAppFailedRetry": "重试",
    "chat.askUserAppFailedMultiple": "此题可多选。",
    "settings.askUserTitle": "向用户提问（ask_user）",
    "settings.askUserDescription": "允许 agent 通过 ask_user 工具向你弹出问题卡片。修改在重新加载会话后生效。",
  ...
  "chat.uploadingImage": "上传中",
  "chat.processingImage": "处理中",
