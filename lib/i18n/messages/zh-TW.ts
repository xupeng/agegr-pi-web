...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.chatFontSize": "對話區字級",
    "settings.chatFontSizeDescription": "以目前字級為基準，放大或縮小對話訊息區的字級，不影響介面其他部分。",
    "settings.fontSizeDefault": "預設",
    "settings.fontSizeDecrease": "縮小對話區字級",
    "settings.fontSizeIncrease": "放大對話區字級",
    "settings.fontSizeReset": "恢復對話區預設字級",
    ...
    "settings.extensionUi": "擴充功能介面",
    "settings.extensionUiDescription": "隱藏在 Pi Web 中沒有用途的擴充功能 Widget 或狀態。",
    "settings.hiddenWidgetKeys": "隱藏的 Widget key",
    "settings.hiddenStatusKeys": "隱藏的狀態 key",
    "settings.extensionUiEmpty": "不隱藏任何 key",
    "settings.extensionUiHint": "每行輸入一個精確 key，或以 * 結尾的前綴。key 標識介面項目，不代表已驗證的擴充功能套件；儲存後會重新載入目前工作階段。",
    "settings.extensionUiSave": "儲存擴充功能介面規則",
    "settings.extensionUiSaving": "正在儲存...",
    ...
    "trellisSubagent.title": "Trellis 執行記錄",
    "trellisSubagent.count": "{count} 筆記錄",
    "trellisSubagent.truncated": "部分記錄已省略",
    "trellisSubagent.coverage.complete": "歷史覆蓋：完整目前分支",
    "trellisSubagent.coverage.incomplete": "歷史覆蓋：不完整，較早結果可能缺失",
    "trellisSubagent.snapshotNotice": "執行快照 — 並非完整對話",
    "trellisSubagent.notRunning": "狀態為最後回報值，不代表程序仍在執行",
    "trellisSubagent.lastReported": "最後回報：{status}",
    "trellisSubagent.updated": "更新於 {time}",
    "trellisSubagent.step": "步驟 {step}",
    "trellisSubagent.stale": "沒有持久化記錄可佐證",
    "trellisSubagent.omittedBudget": "為符合顯示預算而省略文字",
    "trellisSubagent.omittedTools": "省略了 {count} 個較早的工具呼叫",
    "trellisSubagent.unavailable": "無法取得",
    "trellisSubagent.upstreamNotice": "提示詞、尾端與工具摘要可能已由產出端截斷",
    "trellisSubagent.displayTruncated": "Pi Web 為符合顯示限制進一步截斷",
    "trellisSubagent.incomplete": "部分快照欄位無法取得",
    "trellisSubagent.provenance": "來源",
    "trellisSubagent.evidence.partial": "即時局部快照",
    "trellisSubagent.evidence.toolEnd": "工具完成快照",
    "trellisSubagent.evidence.message": "最終訊息快照",
    "trellisSubagent.evidence.history": "已持久化的工作階段歷史",
    "trellisSubagent.mode.single": "單一",
    "trellisSubagent.mode.parallel": "平行",
    "trellisSubagent.mode.chain": "鏈式",
    "trellisSubagent.mode.unknown": "未知模式",
    "trellisSubagent.status.pending": "等待中",
    "trellisSubagent.status.running": "執行中",
    "trellisSubagent.status.succeeded": "已成功",
    "trellisSubagent.status.failed": "失敗",
    "trellisSubagent.status.cancelled": "已取消",
    "trellisSubagent.status.unknown": "未知",
    "trellisSubagent.prompt": "提示詞",
    "trellisSubagent.finalResult": "最終結果",
    "trellisSubagent.textTail": "文字尾端",
    "trellisSubagent.thinkingTail": "思考尾端",
    "trellisSubagent.stderrTail": "stderr 尾端",
    "trellisSubagent.tools": "近期工具",
    "trellisSubagent.usage": "用量",
    "trellisSubagent.error": "錯誤",
    ...
    "chat.writtenFilesCount": "{count} 個檔案",
    "chat.writtenFileActions": "檔案操作",
    "chat.fileType.document": "文件",
    "chat.fileType.code": "程式碼",
    "chat.fileType.image": "圖片",
    "chat.fileType.data": "資料",
    "chat.fileType.config": "設定",
    "chat.fileType.other": "檔案",
    "chat.openFilePreview": "開啟預覽",
    "chat.openFileDiff": "以 Diff 開啟",
    "chat.copyFilePath": "複製路徑",
    "chat.copyFilePathDone": "路徑已複製",
    "chat.loadEarlier": "向上捲動以載入較早的訊息",
    "chat.extensionRequest": "擴充功能請求",
    "chat.askUserTitle": "來自 agent 的問題",
    "chat.askUserAnswered": "已回答 {count}/{total}",
    "chat.askUserOther": "其他",
    "chat.askUserOtherPlaceholder": "輸入你自己的答案…",
    "chat.askUserMultipleOtherPlaceholder": "補充說明（可與所選選項同時提交）…",
    "chat.askUserSupplementTitle": "補充資訊（可選）",
    "chat.askUserSupplementPlaceholder": "補充問題之外的其他資訊…",
    ...
    "chat.askUserAppFailed": "問題檢視載入失敗。",
    "chat.askUserAppFailedHint": "問題仍然開放。可以重試、重新載入頁面，或從其他裝置回答。",
    "chat.askUserAppFailedRetry": "重試",
    "chat.askUserAppFailedMultiple": "此題可多選。",
    ...
    "chat.uploadingImage": "上傳中",
    "chat.processingImage": "處理中",
